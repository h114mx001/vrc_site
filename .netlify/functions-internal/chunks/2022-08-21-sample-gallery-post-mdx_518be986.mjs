const id = "2022-08-21-sample-gallery-post-mdx.mdx";
						const collection = "blog";
						const slug = "2022-08-21-sample-gallery-post-mdx";
						...
						const data = {title:"Sample Gallery post (MDX)",description:"Test post with a photo gallery and lightbox (using PhotoSwipe)",author:{slug:"chris-tham",collection:"author"},publishDate:new Date(1661040000000),coverSVG:{src:"/hello-astro/_astro/undraw_portfolio.b3a4d396.svg",width:848.28391,height:615.2339,format:"svg",orientation:void 0},socialImage:{src:"/hello-astro/_astro/undraw_portfolio.ad118b4d.png",width:1088,height:775,format:"png",orientation:void 0},categories:[{slug:"information",collection:"category"}],tags:["mdx","sample"]};
						const _internal = {
							type: 'content',
							filePath: "/home/bibi/booboo/vrc_site/src/content/blog/2022-08-21-sample-gallery-post-mdx.mdx",
